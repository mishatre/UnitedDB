...
// Возвращает описание ошибки, возникшей в процедуре
// ПередЗапускомПрограммы модуля СтандартныеПодсистемыСервер.
//
// Возращаемое значение:
//  Структура со свойствами:
//   ЕстьОшибка                   - Булево - определяет наличие ошибки.
//   КраткоеПредставлениеОшибки   - Строка. Если ошибка есть, содержит краткое описание.
//   ПодробноеПредставлениеОшибки - Строка. Если ошибка есть, содержит подробное описание.
//   ИнформацияОбОшибке           - ИнформацияОбОшибке - если ошибка была получена в режиме
//                                  исключения иначе Неопределено.
//
Функция ОшибкаПередЗапускомПрограммы() Экспорт
	
	ОписаниеОшибки = Новый Структура;
	ОписаниеОшибки.Вставить("ЕстьОшибка", Ложь);
	ОписаниеОшибки.Вставить("ОшибкаУстановкиМонопольногоРежима", Ложь);
	ОписаниеОшибки.Вставить("ИнформацияОбОшибке", Неопределено);
	ОписаниеОшибки.Вставить("КраткоеПредставлениеОшибки",   "");
