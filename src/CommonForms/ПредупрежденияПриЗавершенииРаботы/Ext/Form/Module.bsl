...
Процедура ПреобразоватьМассивСтруктурВТаблицуЗначений(Предупреждения, ТаблицаПредупреждений)
	...
	ТаблицаПредупреждений.Колонки.Добавить("ОчищатьПредупрежденияДругихОбработчиков");
	...
	Для Каждого ЭлементПредупреждения Из Предупреждения Цикл
		...
		ЭлементПредупреждения.Свойство("ОчищатьПредупрежденияДругихОбработчиков", СтрокаТаблицы.ОчищатьПредупрежденияДругихОбработчиков);
		
		Если СтрокаТаблицы.ОчищатьПредупрежденияДругихОбработчиков <> Истина Тогда
	...
	Отбор = Новый Структура("ОчищатьПредупрежденияДругихОбработчиков", Истина);
