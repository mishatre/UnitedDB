...
Процедура Сохранить(Команда)
	...
	Результат.Вставить("ВариантСохранения", ВариантСохранения);
	Результат.Вставить("ПапкаДляСохранения", ВыбраннаяПапка);
	Результат.Вставить("ОбъектДляПрикрепления", ВыбранныйОбъект);
