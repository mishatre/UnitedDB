...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	ИначеЕсли Режим = 1 Тогда // Неоперативный режим
		...
		|	СУММА(Себестоимость),
		|	СУММА(ТипЦенСтоимость),
		|	СУММА(ТипЦенСтоимость) - СУММА(Себестоимость) КАК ТипЦенНаценка,
		|	ВЫБОР
		|		КОГДА СУММА(ТипЦенСтоимость) <> 0
		|			ТОГДА (СУММА(ТипЦенСтоимость) - СУММА(Себестоимость)) / СУММА(ТипЦенСтоимость) * 100
		|		ИНАЧЕ 0
		|	КОНЕЦ КАК ТипЦенРентабельность,
		|	МАКСИМУМ(ТипЦенЦена)
		|	//ИТОГИ_СВОЙСТВА
